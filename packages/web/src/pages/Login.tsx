    ...
    <div className="h-full">
      <div className="relative flex h-full flex-col items-center justify-center md:grid lg:grid-cols-2 lg:px-0">
        <div className="relative hidden h-full flex-col p-10 text-white lg:flex dark:border-r">
          <div className="absolute inset-0 bg-zinc-200 flex items-center justify-around text-foreground bg-[url('/login-background.jpg')] opacity-60" />
          <div className="absolute inset-0 flex items-center justify-around text-foreground">
            <img
        ...
        <div className="relative lg:p-8 h-full flex flex-col">
